package com.wannabe.app.main.utility.mybatis;
...
public class StringListHandler extends BaseTypeHandler<List<String>> {
    @Override
    public void setNonNullParameter(PreparedStatement psmt, int columnIndex, List<String> list, JdbcType jdbcType) throws SQLException {
