package com.wannabe.app.main.exception.argument;
...
public class IllegalArgumentException extends ExceptionBase {
    ...
    public IllegalArgumentException(Logger l) {
        logger = l;
        errorCode = ResponseCode.INVALID_PARAMETER;
    }

    public IllegalArgumentException(Logger l, @Nullable String message) {
        logger = l;
        errorCode = ResponseCode.INVALID_PARAMETER;
